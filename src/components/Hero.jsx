  ...
  return (
    <>
      ...
      <div className="shadow-md">
        ...
        <div className="flex justify-between items-center mt-8 mx-48">
      ...
      {/*Section*/}
      <div className="flex justify-between h-[202hug] items-center bg-[#F5F7FA]">
        <div className="flex flex-col my-20 gap-2 ml-48">
          <div>
            <h1 className="text-[#4D4D4D] font-semibold text-3xl">
              Helping a local
            </h1>
            <h1 className="font-semibold text-3xl text-[#4CAF4F]">
              business reinvent itself
            </h1>
          </div>
          <span>We reached here with our hard work and dedication</span>
        </div>
        <div className="grid grid-cols-2 gap-x-20 gap-y-10 my-20 mr-48">
          ...
          <div className="flex gap-3">
            ...
            <div>
              <h1 className="text-[#4D4D4D] font-semibold text-3xl">46,328</h1>
              <span className="text-sm text-[#717171]">Clubs</span>
            </div>
          </div>
          <div className="flex gap-3">
            <img src="./events.svg" alt="" />
            <div>
              <h1 className="text-[#4D4D4D] font-semibold text-3xl">828,867</h1>
              <span className="text-sm text-[#717171]">Event Bookings</span>
            </div>
          </div>
          <div className="flex gap-3">
            ...
            <div>
              ...
              <span className="text-sm text-[#717171]">Payments</span>
            </div>
          </div>
        </div>
      </div>
